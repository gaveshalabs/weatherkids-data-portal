...
export class WeatherStationHistoryComponent implements OnInit {
            ...
            datasets: [
                {
                    ...
                    borderColor: '#1BE7FF',
                    pointBackgroundColor: '#1BE7FF',
                    pointBorderColor: '#fff',
                    pointHoverBackgroundColor: '#fff',
                    pointHoverBorderColor: '#1BE7FF',
                },
            ],
        } as ChartData<'line'>,
            ...
            datasets: [
                {
                    ...
                    borderColor: '#EEFC57',
                    pointBackgroundColor: '#EEFC57',
                    pointBorderColor: '#fff',
                    pointHoverBackgroundColor: '#fff',
                    pointHoverBorderColor: '#EEFC57',
                },
            ],
        } as ChartData<'line'>,
        tvoc: {
    ...
    chartOpts: {
        ...
        precipitation: ChartOptions<'line'>;
    ...
    constructor(
        ...
        route.params.subscribe(params => {
            console.log('from url', this.thisWeatherStation, params.ws_id);
